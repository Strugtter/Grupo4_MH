...
createChecks("https://pro-talento.up.railway.app/api/amazing/?time=upcoming");
...
async function filterData() {
  try {
    ...
    let url = `https://pro-talento.up.railway.app/api/amazing/?time=upcoming&name=${texto}&category=${categoria}`;
    let response = await fetch(url);
    response = await response.json();
    loadItems(response.response);
